const data = ["д-30","мт-12","т-12","т12","д-20","2а36","2а65","2а46","2а46м","2а33","2а31","шкала","сальники"];
...
function searchData(){
    ...
    if(i.includes("д-30")){
        ...
        <img src="img/d30.png" style="width:300px; margin:10px; border-radius:10px;">
    ...
    else if(i.includes("шкала")){
    result.innerHTML = `
    <h2>Шкала рівня рідини</h2>

    <p><b>Два види шкали рівня рідини в механізмі підйому ствола</b></p>

    <img src="img/scale1.png" style="width:280px; margin:10px;">
    <img src="img/scale2.png" style="width:280px; margin:10px;">
    `;
    }
        ...
        <img src="img/t12.png" style="width:300px; margin:10px; border-radius:10px;">
    ...
    // 🟢 Д-20
        ...
        <img src="img/d20.png" style="width:300px; margin:10px; border-radius:10px;">
        <p><b>Довжина відкату :</b></p>
    ...
    // 🟡 2А36
        ...
        <img src="img/2a36.png" style="width:300px; margin:10px; border-radius:10px;">
    ...
    // ⚫ 2А46
        ...
        <img src="img/scale1.png" style="width:280px; margin:10px;">
        <img src="img/scale2.png" style="width:280px; margin:10px;">
        <img src="img/2a46.png" style="width:300px; margin:10px; border-radius:10px;">
        `;
    }
    ...
    else if(i.includes("сальники")){
    result.innerHTML = `
    <h2>Сальники</h2>

    <p><b>Сальники використовуються для герметизації вузлів та утримання рідини.</b></p>

    <img src="img/seals1.png" style="width:280px; margin:10px;">
    <img src="img/seals2.png" style="width:280px; margin:10px;">
    <img src="img/seals3.png" style="width:280px; margin:10px;">
    <img src="img/seals4.png" style="width:280px; margin:10px;">
    <img src="img/seals5.png" style="width:280px; margin:10px;">
      `;
     }
